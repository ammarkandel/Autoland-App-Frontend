  ...
  const sendRequest = async () => {
    ...
    const response = await fetch(
      '/appointments.json',
      {
        ...
        body: `appointment[date]=${appointmentData.date}&appointment[time]=${appointmentData.time}&appointment[user_id]=${appointmentData.user_id}&appointment[car_id]=${appointmentData.car_id}`,
      },
    );
